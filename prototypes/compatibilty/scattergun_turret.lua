...
if settings.startup["casting-weapons"].value then
    ...
    data:extend({
        {-- casting w93 turrets and guns
            ...
            effects =
            {
                ...
                {type = "unlock-recipe", recipe = "pulse-w93-modular-turret2-base"},
    ...
    local gun_unlock_mapping = {
        ["pulse-w93-modular-gun-plaser"] = "w93-modular-turrets-plaser",
        ["pulse-w93-radar"] = "w93-modular-turrets-radar",
        ["pulse-w93-radar2"] = "w93-modular-turrets-radar",
    }
